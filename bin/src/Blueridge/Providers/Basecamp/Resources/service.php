...
return array(
    ...
    'operations'            => array(
        'getProjects' => array(
            'httpMethod' => 'GET',
            'uri'       => '{accountId}/api/{version}/projects.json',
        ...
        'getProject' => array(
            'httpMethod' => 'GET',
            'uri'        => '{accountId}/api/{version}/projects/{id}.json',
            'parameters' => array(
                'accountId' => array(
                    'location' => 'uri',
                    'description' => 'Account Id',
        ...
        'getDocumentsByProject' => array(
            'httpMethod' => 'GET',
            'uri' => '{accountId}/api/{version}/projects/{id}/documents.json',
            'parameters' => array(
                'projectId' => array(
                    'location' => 'uri',
        ...
        'getDocument' => array(
            'httpMethod' => 'GET',
            'uri' => '{accountId}/api/{version}/projects/{projectId}/documents/{documentId}.json',
            'parameters' => array(
                'projectId' => array(
                    'location' => 'uri',
        ...
        'getTodolist' => array(
            'httpMethod' => 'GET',
            'uri' => '{accountId}/api/{version}/projects/{projectId}/todolists/{todolistId}.json',
            'parameters' => array(
                'accountId' => array(
                    'location' => 'uri',
                    'description' => 'Account id',
        ...
        'getTodolistsByProject' => array(
            'httpMethod' => 'GET',
            'uri' => '{accountId}/api/{version}/projects/{projectId}/todolists.json',
            'parameters' => array(
                'projectId' => array(
                    'location' => 'uri',
                    'description' => 'Project id',
        ...
        'getCurrentUser' => array(
            'httpMethod' => 'GET',
            'uri' => '{accountId}/api/{version}/people/me.json',
            'parameters' => array(
                'accountId' => array(
                    'location' => 'uri',
                    'description' => 'Account Id',
        ...
        'getTodo' => array(
            'httpMethod' => 'GET',
            'uri' => '{accountId}/api/{version}/projects/{projectId}/todos/{todoId}.json',
            'parameters' => array(
                'accountId' => array(
                    'location' => 'uri',
                    'description' => 'Account id',
