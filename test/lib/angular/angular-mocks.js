 ...
 *
 * <pre>
 *   blueRidgeDev = angular.module('blueRidgeDev', ['blueRidge', 'ngMockE2E']);
 *   blueRidgeDev.run(function($httpBackend) {
...
>>>>>>> 8dca056... docs(mocks): fix typos
   ...
   * <pre>
   *
   *   angular.module('blueRidgelicationModule', [])
   *       .value('mode', 'app')
   ...
   *     beforeEach(module('blueRidgelicationModule'));
   *
   *
